                ...
                <div class="col-12">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-0 text-primary">
                            <i class="fas fa-building me-2"></i> Edit Toilet
                        </h4>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="room" class="form-label fw-semibold">
                                                <i class="fas fa-tag me-1"></i> Room Name <sup
                                                    class="text-danger fs-6">*</sup>
                                            </label>
                                            <input type="text" id="room" name="name" class="form-control"
                                                placeholder="Enter Room Name" value="{{ $room->name }}" required>
                                            <div class="valid-feedback">Looks good!</div>
                                            <div class="invalid-feedback">Room name is required.</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select id="room" name="building_id" class="form-select" required>
                                            ...
                                            <select id="toilet" name="category_id" class="form-select" required>
                                                ...
                                                @foreach ($categories as $key => $category)
                                                    <option value="{{ $category->id }}"
                                                        @if ($room->category_id == $category->id) selected @endif>
