                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold"><a href="/admin/users" style="color: white">{{ $users }}</a></h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold"><a href="/admin/buildings" style="color: white">{{ $buildings }}</a></h3>
                                </div>
                                <div class="card-icon display-6">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold"><a href="/admin/floors" style="color: white">{{ $floors }}</a></h3>
                                </div>
                                <div class="card-icon display-6">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold"><a href="/admin/rooms" style="color: white">{{ $rooms }}</a></h3>
                                </div>
                                <div class="card-icon display-6">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold"><a href="/admin/feedbacks" style="color: white">{{ $feedbacks }}</a></h3>
                                </div>
                                <div class="card-icon display-6">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold"><a href="/admin/complaints" style="color: white">{{ $complaints }}</a></h3>
                                </div>
                                <div class="card-icon display-6">
