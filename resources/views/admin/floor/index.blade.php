            ...
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <h4 class="text-primary">
                        <i class="fas fa-building"></i> Floor List
                    </h4>
                    <a href="{{ route('admin.floor.create') }}" class="btn btn-primary">
                        <i class="fas fa-plus-circle me-1"></i> Add New Fllor
                    </a>
                </div>
            </div>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-sm btn-danger sa-delete"
                                            data-id="{{ $floor->id }}" data-link="/admin/floor/delete/"
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted">No floors found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
